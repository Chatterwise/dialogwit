    ...
    <div className="space-y-8">
      ...
      {isLoading ? (
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-500">Loading chatbots...</p>
        </div>
      ) : chatbots.length === 0 ? (
        <div className="text-center py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {chatbots.map((chatbot) => (
            <div
              key={chatbot.id}
              className="bg-white/90 rounded-2xl shadow-xl border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow duration-200"
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex items-center">
                    <Bot className="h-9 w-9 text-primary-600" />
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-gray-900">
                        {chatbot.name}
                      </h3>
                ...
                <div className="flex space-x-2">
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center px-3 py-2 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200"
                  >
