...
export const ChatbotDetail = () => {
  ...
  const { data: analytics, isLoading: analyticsLoading } = useChatAnalytics(id || '')
  const [activeTab, setActiveTab] = useState<'overview' | 'chat' | 'knowledge' | 'analytics'>('overview')
  ...
  if (!chatbot) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900">Chatbot not found</h3>
            ...
            <div className="p-6">
              {messagesLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Start testing your chatbot to see conversations here.</p>
                </div>
              ) : (
          ...
          <div className="bg-white rounded-lg shadow border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-sm text-gray-500">{knowledgeBase.length} items</span>
                  <Link
                    to="/knowledge-base"
            ...
            <div className="p-6">
              {kbLoading ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">No knowledge base items</h3>
                  <p className="text-gray-500">Add content to help your chatbot answer questions.</p>
                  <Link
                    to="/knowledge-base"
                ...
                <div className="bg-white rounded-lg shadow border border-gray-200 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium">{analytics?.totalMessages || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">This Week</span>
                      <span className="text-sm font-medium">{analytics?.weeklyMessages || 0}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">Avg Response Length</span>
                      <span className="text-sm font-medium">{analytics?.avgResponseLength || 0} chars</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600">Knowledge Base Size</span>
                      <span className="text-sm font-medium">{knowledgeBase.length} items</span>
                    </div>
                  </div>
                </div>
