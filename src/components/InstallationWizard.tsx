...
<script 
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Step Content */}
      <div className="bg-white/90 rounded-2xl shadow-xl border border-gray-100 p-8 min-h-[500px]">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                  <button
                    onClick={copyCode}
                    className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-primary-50 transition-colors"
                  >
                    {copiedCode ? (
            ...
            {selections.botId && (
              <div className="bg-primary-50 border border-primary-200 rounded-xl p-4">
                <div className="flex items-start">
                  <Bot className="h-5 w-5 text-primary-600 mt-0.5 mr-3" />
                  <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link
                to="/templates"
                className="p-4 border border-gray-200 rounded-xl hover:bg-primary-50 transition-colors text-center"
              >
              ...
              <Link
                ...
                className="p-4 border border-gray-200 rounded-xl hover:bg-primary-50 transition-colors text-center"
              >
                <Settings className="h-6 w-6 text-accent-600 mx-auto mb-2" />
      ...
      <div className="flex justify-between mt-6">
        <button
          ...
          className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
        ...
        {currentStep < steps.length - 1 ? (
          <button
            onClick={nextStep}
            disabled={!canProceed()}
            className="flex items-center px-4 py-2 text-sm font-semibold text-white bg-primary-600 border border-transparent rounded-xl hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Next
          ...
          <button
            ...
            className="flex items-center px-4 py-2 text-sm font-semibold text-white bg-green-600 border border-transparent rounded-xl hover:bg-green-700 transition-colors"
          >
            Start Over
