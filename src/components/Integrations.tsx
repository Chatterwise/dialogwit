    ...
    <div className="space-y-10">
      ...
      <div className="bg-gradient-to-r from-primary-50 via-white to-accent-50 border border-primary-100 rounded-2xl p-6 shadow-card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-white border border-primary-100 rounded-xl shadow-subtle">
            <div className="flex items-center mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center">
                  <Check className="h-4 w-4 text-green-500 mr-2" />6 beautiful
                  pre-built templates
                </li>
                <li className="flex items-center">
            ...
            <div>
              ...
              <ol className="text-sm text-gray-600 space-y-2">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Download templates:</strong> Get the template files
                    from the gallery or copy the code above
                  </div>
                </li>
                <li className="flex items-start">
                  <span className="flex-shrink-0 w-6 h-6 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-xs font-medium mr-3 mt-0.5">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Configure API:</strong> Update your bot ID and API
                    endpoints
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Import & use:</strong> Add the template component to
                    your app
                  </div>
                </li>
              </ol>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100">
          ...
          {/* ... (rest of your code for script tag integration, code copy/download, features, etc.) */}
          <div className="px-6 py-6 space-y-6">
            <div>
              <h4 className="text-sm font-medium text-gray-900 mb-3">
                ✨ Features
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex justify-between">
                  ...
                  <span>
                    modern, minimal, bubble, professional, gaming, elegant
                  </span>
                </div>
                <div className="flex justify-between">
                  <code className="bg-gray-100 px-2 py-1 rounded text-xs">
            ...
            <div>
              ...
              <ol className="text-sm text-gray-600 space-y-2">
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Host the widget:</strong> Upload chatbot-widget.js
                    to your server
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Add script tag:</strong> Include the script with
                    your configuration
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Configure API:</strong> Update bot ID and API
                    endpoints
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <strong>Customize:</strong> Adjust template, colors, and
                    position
                  </div>
                </li>
              </ol>
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="px-6 py-6">
          {/* ... (your code for the headless hook, code copy/download, and usage examples) */}
