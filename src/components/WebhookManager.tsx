    ...
    <div className="space-y-6  min-h-screen">
      ...
      {webhooks.length === 0 ? (
        <div className="text-center py-12">
          <Webhook className="h-12 w-12 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      readOnly
                      className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700 font-mono text-sm"
                    />
                    <button
                      onClick={() => toggleSecret(webhook.id)}
                      className="p-2 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700"
                    >
                  ...
                  {availableEvents.map((event) => (
                    <label key={event} className="flex items-center">
                      <input
                        ...
                        className="rounded border-gray-300 text-primary-600 focus:ring-primary-500 dark:border-gray-700 dark:bg-gray-700"
                      />
      ...
      <ActionModal
        ...
        action={{
          ...
          affectedItems: ["Webhook configuration", "All related events"],
          onConfirm: async () => {
            if (webhookToDelete) {
              await handleDeleteWebhook(webhookToDelete.id);
            }
          },
          ...
          note: "This will permanently remove the webhook and all its data.",
        }}
      />
    </div>
  );
