...
const CommunityPage: React.FC = () => {
  const upcomingEvents = [
    {
      ...
      location: "Virtual",
      description:
        "Join us for our monthly community meetup to discuss the latest features and share tips.",
    },
    {
      ...
      location: "Virtual",
      description:
        "Learn how to build and deploy enterprise-grade chatbots with advanced security features.",
    },
    {
      ...
      description:
        "Our annual developer conference featuring workshops, talks, and networking opportunities.",
    },
  ];
  ...
  const communitySpotlights = [
    ...
    },
    {
      ...
      contribution:
        "Shared best practices for organizing large knowledge bases",
      avatar: "PP",
      color: "bg-purple-500",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
            ChatterWise Community
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Join thousands of developers, businesses, and AI enthusiasts
            ...
            {[
              {
                platform: "Discord",
                description:
                  "Chat with community members and get real-time help",
                icon: MessageSquare,
                color:
              ...
              },
              {
                platform: "Twitter",
                description:
                  "Follow us for news, tips, and community highlights",
                icon: Twitter,
                color:
              ...
              >
                <div
                  className={`p-3 ${platform.color} rounded-full inline-block mb-4`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Watch step-by-step tutorials and best practices videos",
                icon: Youtube,
                link: "#",
              },
              // {
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              There are many ways to contribute to the ChatterWise community and
            ...
            {[
              {
                ...
                description:
                  "Write tutorials, answer questions, or create templates for the community",
                icon: BookOpen,
                color:
                  "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400",
              },
              {
                ...
                description:
                  "Contribute to our open source projects, report bugs, or suggest features",
                icon: Github,
                color:
                  "bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400",
              },
              {
                ...
                description:
                  "Join our community champions program and help others succeed",
                icon: Award,
                color:
              ...
              >
                <div
                  className={`p-3 ${way.color} rounded-xl inline-block mb-4`}
                >
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-6">
            Stay up to date with the latest news, events, and resources from the
            ChatterWise community
          </p>
