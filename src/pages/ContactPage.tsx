      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          {[
            {
              title: "Chat With Us",
              description: "Get immediate help from our support team through live chat",
              icon: MessageSquare,
              action: "Start Chat",
              link: "#chat",
            ...
            },
            {
              ...
              icon: Mail,
              action: "support@chatterwise.ai",
              link: "mailto:support@chatterwise.ai",
            ...
            >
              <div className={`p-3 ${option.color} rounded-xl inline-block mb-4`}>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center">Our Offices</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {offices.map((office, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 hover:shadow-xl transition-shadow"
              >
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">{office.city}</h3>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              { name: "Twitter", icon: Twitter, link: "#", color: "bg-blue-500 hover:bg-blue-600" },
              { name: "LinkedIn", icon: Linkedin, link: "#", color: "bg-blue-700 hover:bg-blue-800" },
              { name: "GitHub", icon: Github, link: "#", color: "bg-gray-800 hover:bg-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600" },
              { name: "Website", icon: Globe, link: "#", color: "bg-green-600 hover:bg-green-700" },
            ].map((social) => (
              <a
                key={social.name}
                href={social.link}
