-- 1. Ensure required columns exist and are not null
alter table usage_tracking
  alter column period_start set not null,
  alter column period_end set not null,
  alter column usage_source set not null;

-- 2. Update function to auto-align token usage tracking with Stripe billing cycles
...
declare
  sub_record record;
begin
  -- Get the latest active subscription period for the user
